Locales ['en'] = {
  ...
  ['shop_menu_title'] = 'Ammunation Gun Store',
  ['shop_menu_prompt'] = 'press ~INPUT_CONTEXT~ to access the ~y~Ammunation Gun Store~s~.',
  ['shop_menu_item'] = '$%s',
  ['map_blip'] = 'Ammunation Gun Store',
  ['not_owned'] = 'you not own this weapon!',
}
